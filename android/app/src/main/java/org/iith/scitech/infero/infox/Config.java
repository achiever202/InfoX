...
import org.iith.scitech.infero.infox.util.ParserUtils;
...
public class Config {
    ...
    // YouTube API config
    public static final String YOUTUBE_API_KEY = "AIzaSyAiAvWJ9LayNkS-TDo15G2B1c3jSu8C8xo";
    ...
    public interface Tags {
        ...
        /*public static final int[] EXPLORE_CATEGORY_ALL_STRING = {
                org.iith.scitech.infero.infox.R.string.all_themes, org.iith.scitech.infero.infox.R.string.all_topics, org.iith.scitech.infero.infox.R.string.all_types
        };

        public static final int[] EXPLORE_CATEGORY_TITLE = {
                org.iith.scitech.infero.infox.R.string.themes, org.iith.scitech.infero.infox.R.string.topics, org.iith.scitech.infero.infox.R.string.types
        };*/
    }
