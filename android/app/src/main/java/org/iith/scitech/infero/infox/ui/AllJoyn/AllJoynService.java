 ...
 */
package org.iith.scitech.infero.infox.ui.AllJoyn;
...
public class AllJoynService extends Service implements Observer, Serializable {
    ...
    public void onCreate() {
        ...
        CharSequence title = "InfoX";
        CharSequence message = "Data Transfer Service.";
     ...
     * advertise.
     */
    public static final String NAME_PREFIX = "org.alljoyn.bus.samples.chat";
    ...
    private void doAdvertise() {
         ...
         */
        String wellKnownName = NAME_PREFIX + "." + mChatApplication.hostGetChannelName();
        Log.v("wellKnownName: ",wellKnownName);
